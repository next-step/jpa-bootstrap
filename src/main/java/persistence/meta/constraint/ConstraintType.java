...
public enum ConstraintType {
  ...
  COLUMN((annotation -> annotation.annotationType() == Column.class), "nullable",
      Map.of("false", "NOT NULL", "true", ""));
  ...
  ConstraintType(Predicate<Annotation> predicate, String optionParam,
      Map<String, String> constraintMapping) {
