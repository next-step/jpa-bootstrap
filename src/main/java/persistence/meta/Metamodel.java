...
public class Metamodel {
    ...
    public Metamodel(List<Class<?>> entityClasses, JdbcTemplate jdbcTemplate) {
        this.tableDefinitions = entityClasses.stream().collect(
        ...
        this.entityPersisters = entityClasses.stream().collect(
                Collectors.toUnmodifiableMap(
                        clazz -> clazz,
        ...
        this.entityCollectionPersisters = tableDefinitions.values().stream().flatMap(tableDefinition ->
