...
public class JoinQuery {
  ...
  private void validateQuery() {
    if (selectClause.isEmpty() || tableName.isEmpty() || tablesToJoin.isEmpty() || foreignKey.isEmpty() || targetName.isEmpty() || targets.isEmpty()){
      throw new IllegalArgumentException("불완전 Join Query 입니다.");
    }
  }
