...
class OneToManyAssociationTest {
    ...
    void noJoinColumnCreateAssociate() throws Exception {
        //given
        OneToManyAssociation oneToManyColumn = OneToManyAssociation.createOneToMayAssociationByClass(
                NoHasJoinColumnOrder.class, EntityMeta.from(NoHasJoinColumnOrder.class));
