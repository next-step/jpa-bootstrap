...
class DefaultDdlQueryBuilderTest extends EntityMetaDataTestSupport {
    ...
    public void buildCreateQueryV1() throws Exception {
        // given
        final PersistentClass<PersonV1> persistentClass = persistentClassMapping.getPersistentClass(PersonV1.class);
    ...
    public void buildCreateQueryV2() throws Exception {
        // given
        final PersistentClass<PersonV2> persistentClass = persistentClassMapping.getPersistentClass(PersonV2.class);
        final Table table = tableBinder.createTable(persistentClass);
