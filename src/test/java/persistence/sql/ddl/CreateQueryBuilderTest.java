...
class CreateQueryBuilderTest {
    ...
    void pkHasCreateQuery() {
        //given
        final QueryGenerator query = QueryGenerator.of(dialect);

        //when
        String sql = query.create().build(PkHasPerson.class);
    ...
    void changColumNameQuery() {
        ...
        //when
        String sql = query.create().build(ChangColumNamePerson.class);
    ...
    void transientAndTableQuery() {
        //given
        final QueryGenerator ddl = QueryGenerator.of(dialect);

        //when
        String sql = ddl.create().build(Person.class);
    ...
    void dialectChange() {
        //given
        final QueryGenerator ddl = QueryGenerator.of(new UpperStringDirect());
