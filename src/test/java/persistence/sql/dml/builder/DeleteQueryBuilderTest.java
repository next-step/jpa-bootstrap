...
class DeleteQueryBuilderTest {
    ...
    void doNotHaveEntityAnnotation() {
        assertThrows(IllegalArgumentException.class, () -> DeleteQueryBuilder.of(EntityMeta.of(PureDomain.class)), "Delete Query 빌드 대상이 아닙니다.");
    }

    @Test
    @DisplayName("테이블 데이터 전체 삭제")
    void deleteAll() {
        DeleteQueryBuilder deleteQueryBuilder = DeleteQueryBuilder.of(EntityMeta.of(Person.class));
    ...
    void deleteEntityInstance() {
        DeleteQueryBuilder deleteQueryBuilder = DeleteQueryBuilder.of(EntityMeta.of(MockEntity.class));
