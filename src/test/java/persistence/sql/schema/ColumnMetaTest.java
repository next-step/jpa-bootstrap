...
class ColumnMetaTest {
    ...
    void createColumnMetaWithNoColumnName() throws NoSuchFieldException {
        ...
        final ColumnMeta idColumnMeta = ColumnMeta.of(ColumnMetaFixture.class.getDeclaredField(idFieldName), new H2Dialect());
        final ColumnMeta indexColumnMeta = ColumnMeta.of(ColumnMetaFixture.class.getDeclaredField(indexFieldName), new H2Dialect());
    ...
    void createColumnMetaWithColumnName() throws NoSuchFieldException {
        ...
        final ColumnMeta nameColumnMeta = ColumnMeta.of(ColumnMetaFixture.class.getDeclaredField(nameFieldName), new H2Dialect());
    ...
    void createColumnMetaWithColumnNotNullConstraint() throws NoSuchFieldException {
        ...
        final ColumnMeta nameColumnMeta = ColumnMeta.of(ColumnMetaFixture.class.getDeclaredField(indexFieldName), new H2Dialect());
